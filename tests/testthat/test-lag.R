...
testthat::test_that("Lags", {
  ...
  lag <- dplyr::lag
  lead <- dplyr::lead
  expect_identical(fdiff2(x, n = 1), as.integer(x - lag(x)))
  expect_identical(fdiff2(x, n = 3), as.integer(x - lag(x, 3)))
  expect_identical(fdiff2(x, n = 100), as.integer(x - lag(x, 100)))
  ...
  expect_identical(fdiff2(y, n = 100), y - lag(y, 100))
  ...
  expect_identical(fdiff2(z, n = 100), as.integer(z - lag(z, 100)))
...
testthat::test_that("Grouped lags", {
  ...
  expect_identical(fdiff2(x, g = gx, n = 3), diff3(x, g = gx, n = 3))
  expect_identical(fdiff2(x, g = gx, n = 100), diff3(x, g = gx, n = 100))
  expect_identical(fdiff2(x, g = gx, n = 300), diff3(x, g = gx, n = 300))
  expect_identical(fdiff2(x, g = gx, n = -1), diff4(x, g = gx, n = 1))
  expect_identical(fdiff2(x, g = gx, n = -3), diff4(x, g = gx, n = 3))

  expect_equal(fdiff2(y, g = gy, n = 1), diff3(y, g = gy, n = 1))
  expect_equal(fdiff2(y, g = gy, n = 3), diff3(y, g = gy, n = 3))
  expect_equal(fdiff2(y, g = gy, n = 100), diff3(y, g = gy, n = 100))
  expect_equal(fdiff2(y, g = gy, n = 300), diff3(y, g = gy, n = 300))
  expect_equal(fdiff2(y, g = gy, n = -1), diff4(y, g = gy, n = 1))
  expect_equal(fdiff2(y, g = gy, n = -3), diff4(y, g = gy, n = 3))

  expect_equal(fdiff2(z, g = gz, n = 1), diff3(z, g = gz, n = 1))
  expect_equal(fdiff2(z, g = gz, n = 3), diff3(z, g = gz, n = 3))
  expect_equal(fdiff2(z, g = gz, n = 100), diff3(z, g = gz, n = 100))
  expect_equal(fdiff2(z, g = gz, n = 300), diff3(z, g = gz, n = 300))
  expect_equal(fdiff2(z, g = gz, n = -1), diff4(z, g = gz, n = 1))
  expect_equal(fdiff2(z, g = gz, n = -3), diff4(z, g = gz, n = 3))

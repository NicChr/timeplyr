...
forward by default which is different to lubridate which rolls backwards by
default
...
options 'xfirst', 'xlast', 'preday', 'postday', 'boundary', 'full' and 'NA'.
The 'xfirst' and 'xlast' options are timeplyr specific and signify crossed-first
and crossed-last dates respectively. 'xlast' is set by default package-wide.
